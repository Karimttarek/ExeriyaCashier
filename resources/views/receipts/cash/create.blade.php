<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb>
            <x-slot name="breadcrumb">
                ...
                <p class="ml-1 text-sm font-medium hover:text-blue-800 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{__('app.NEWCASHRECEIPT')}}</p>
                </li>
            </x-slot>
        </x-breadcrumb>
    </x-slot>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        <form method="POST" action="{{route('Cash.store')}}" enctype="multipart/form-data">
            @csrf
            <!-- Receipt Type -->
            <div class="mb-2">
...
{{--                        <span class="text-red-500">*</span>--}}
{{--                    </label>--}}
{{--                    <input type="text" name="exp_code" value="{{ old('exp_code') }}" id="exp_code" class="@error('exp_code') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"--}}
{{--                    disabled>--}}
{{--                    @error('exp_code')--}}
{{--                    <div>--}}
{{--                        <span class="font-medium text-red-600">{{$message}}</span>--}}
