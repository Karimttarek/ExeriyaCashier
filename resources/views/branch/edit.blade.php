<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb>
            <x-slot name="breadcrumb">
                ...
                <p class="ml-1 text-sm font-medium hover:text-blue-800 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{__('app.Edit Branch')}}</p>
                </li>
            </x-slot>
        </x-breadcrumb>
    </x-slot>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        @foreach ($branch as $b)
        <form method="POST" action="{{route('Branch.update' ,$b->id)}}" enctype="multipart/form-data">
            @csrf
            <!-- Name -->
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input type="text" name="email" value="{{ $b->email }}" class="@error('email') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('email')
                 <div>
                     <span class="font-medium text-red-600">{{$message}}</span>
                 </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="mobile" value="{{ $b->mobile }}" class="@error('mobile') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('mobile')
                 <div>
                     <span class="font-medium text-red-600">{{$message}}</span>
                 </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="mb-2">
                    ...
                    <select name="governorate" id="gov" class="@error('governorate') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        <option selected value="{{ $b->governorate }}">--{{ $b->governorate }}--</option>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="mb-2">
                    ...
                    <select name="city" id="cities" class="@error('city') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        <option selected value="{{ $b->city }}">--{{ $b->city }}--</option>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="building_number" value="{{ $b->building_number }}" class="@error('building_number') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
