        ...
        <form class="lg:w-1/3  sm:w-1/2">
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 mb-3">
                ...
                <div class="mt-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="product-filter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        >
                    </div>
                    <!-- Parent -->
                    <div class="mb-2">
                        ...
                        <select id="product-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected disabled>{{__('app.SELECTPRODUCT')}}</option>
                            @foreach ($products as $product)
                                    <option value="{{$product->name}}" data-name="{{$product->name}}" data-barcode="{{ $product->bar_code }}"
                                        data-itemcode="{{$product->item_code}}" data-description="{{$product->description}}" data-uuid="{{$product->uuid}}"
                                        data-price="{{$product->first_unit_sell_price}}" data-first_unit_type="{{$product->first_unit_type}}"
                                        data-second_unit_type="{{$product->second_unit_type}}" data-third_unit_type="{{$product->third_unit_type}}"
                                        data-first_unit_sell_price="{{ $product->first_unit_sell_price }}" data-second_unit_sell_price="{{ $product->second_unit_sell_price }}"
                                        data-third_unit_sell_price="{{ $product->third_unit_sell_price }}">
                                        {{$product->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" tabindex="-1" id="product-itemCode" class="bg-gray-100 text-gray-900 border-none text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:text-white"
                            readonly>
                        </div>
                    </div>
                    <!-- Item Name -->
                    <div class="mb-2">
                        ...
                        <input type="text" tabindex="-1" id="product-name" class="bg-gray-100 text-gray-900 border-none text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:text-white"
                        readonly>
                    </div>
                    <!-- Item Description -->
                    {{-- <div class="mb-2">
                        ...
                        <input type="text" tabindex="-1" id="product-description" class="bg-gray-100 text-gray-900 border-none text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:text-white"
                        readonly>
                    </div> --}}
                    <!-- Qty & Unit Type -->
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="mb-2">
                            ...
                            >
                            <div class="grid grid-cols-2 gap-2 stockDiv">
                                <p class="stock font-bold">{{__('app.Current Stock')}} : </p>
                                <p class="stock font-bold" id="currentStock"></p>
                            </div>
                        ...
                        <div class="mb-2">
                            ...
                            <select name="product-type" id="product-type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                {{-- <option selected value="{{$units[0]->name}}">{{$units[0]->name}}</option> --}}
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" tabindex="-1" id="product-price" step=".000001" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        {{-- <!-- Unit Type -->
                        <div class="mb-2">
                            ...
                            <input type="text" id="currency" readonly value="EGP" class="bg-gray-100 text-gray-900 border-none text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:text-white">
                        </div> --}}
                    </div>
                    <!-- Discount -->
                    {{-- <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" tabindex="-1" id="product-net" class="bg-gray-100 text-gray-900 border-none text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:text-white"
                        readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" tabindex="-1" id="product-total" class="bg-gray-100 text-gray-900 border-none text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:text-white"
                        readonly>
                    </div>
                    <!--Form -->
                    <p class="text-sm">{{__('app.PRODUCTAPPLYNOTE')}}</p>
                    <span class="text-red-600 font-bold" id="err-list"></span>
                </div>
            </div>
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button type="button" class="mt-3 inline-flex justify-start rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                    onclick="$('#InvoiceItems').addClass('hidden');$('#paid').focus();">
                    {{__('app.CANCEL')}}
                </button>
            </div>
            </div>
