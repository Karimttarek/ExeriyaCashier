<x-app-layout>
        ...
        <x-breadcrumb>
            <x-slot name="breadcrumb">
                ...
                <li class="inline-flex items-center">
                    ...
                    <p class="ml-1 text-sm font-medium hover:text-blue-800 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{__('app.New Revenue')}}</p>
                </li>
            </x-slot>
        </x-breadcrumb>
    </x-slot>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        <form method="POST" action="{{route('Finances.Revenues.store')}}" enctype="multipart/form-data">
            @csrf
