<x-app-layout>
        ...
        <x-breadcrumb>
            <x-slot name="breadcrumb">
                <li class="inline-flex items-center">
                    ...
                    <a href="{{route('Finances.Expenses.get')}}"
                ...
                <li class="inline-flex items-center">
                    ...
                    <p class="ml-1 text-sm font-medium hover:text-blue-800 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{__('app.New Expense')}}</p>
                </li>
            </x-slot>
        </x-breadcrumb>
    </x-slot>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        <form method="POST" action="{{route('Finances.Expenses.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid gap-6 md:grid-cols-2 mt-5">
                ...
                <div class="mb-2">
                    ...
                    <input type="datetime-local" name="receipt_date" value="{{ date("Y-m-d\TH:i", strtotime(now())) }}"
            ...
            <div class="grid grid-flow-row-dense grid-cols-3 gap-6">
                ...
                <div class="mb-2 col-span-1">
                    ...
                    <input type="number" step="0.000001" name="value" value="{{ old('value') }}" id="value"
                ...
                <div class="mb-2 col-span-2">
                    ...
                    <input type="text" name="value_text" value="{{ old('value_text') }}" id="value_text"
    ...
    @include('modal.finances.expenses')
    @push('script')
