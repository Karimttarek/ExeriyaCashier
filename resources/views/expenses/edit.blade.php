<x-app-layout>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        ...
        <form method="POST" action="{{route('Expenses.update',$exp->id)}}" enctype="multipart/form-data">
            @csrf
            <!-- Code -->
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" pattern="[0-9]+" name="code" value="{{ $exp->code }}" class="@error('code') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required>
                    @error('code')
                    <div>
            ...
            <div class="mb-2">
              ...
              <input type="text" name="name" value="{{ $exp->name }}" class="@error('name') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
              @error('name')
               <div>
                   <span class="font-medium text-red-600">{{$message}}</span>
               </div>
