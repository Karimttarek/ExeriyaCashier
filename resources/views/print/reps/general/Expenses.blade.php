...
<body>
    ...
    <div class="mb-5 p-1 rounded" style="background: #eee !important;">
        <h1 class="text-center text-bold">{{ __('app.Expenses Rep')  }}</h1>
    </div>
    <div class="mb-5">
        <div class="col-6 table-responsive text-lg">
            <table class="table-striped">
                ...
                <tr>
                    ...
                    <td>{{  date('Y-m-d h:m' , strtotime( array_key_exists('Receipt Date' , $data[0]) ? $data[count($data) -1]['Receipt Date'] : $data[count($data) -1]['تاريخ السند'] )) }}</td>
                </tr>
            </table>
        </div>
    </div>
