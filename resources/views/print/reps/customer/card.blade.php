...
<body>
    ...
    <div class="mb-5 p-1 rounded" style="background: #eee !important;">
        <h1 class="text-center text-bold">{{ __('app.Customers Card Rep')  }}</h1>
    </div>
    <div class="mb-5">
                ...
                <table class="table table-striped table-sm table-bordered text-center">
                    ...
                    @endforeach
                        <tr>
                            ...
                            <td>{!! number_format(intval(array_sum(array_column($data, array_key_exists('Credit' , $data[0]) ? 'Credit' : 'دائن')) - array_sum(array_column($data,array_key_exists('Debit' ,$data[0]) ? 'Debit' : 'مدين')))  , 5) !!}</td>
                        </tr>
                </table>
            </div>
        </div>
