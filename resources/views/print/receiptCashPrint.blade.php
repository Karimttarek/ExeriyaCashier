    ...
    @foreach($receipt as $rec)
        <div class="container-xl m-t-200">
            <div class="form-group row text-center text-bold m-t-10" style="border:1px solid #000">
                    <h2 class="col-12">{{__('app.CASHRECEIPT')}}</h2>
                <div class="bordered">
                    <!-- POUNDS -->
                    ...
                    <!-- CUSTOMER -->
                    <div class="form-group row text-center">
                        <p for="code_type" class="col-sm-2 col-form-label">{{__('app.RECEIVERNAME')}}</p>:
                        <div class="col-sm-9 text-left">
                            <p class="col-sm-12 col-form-label border-bottom">{{$rec->supplier_name . $rec->customer_name. $rec->receiver_name}}</p>
                        </div>
                    </div>
                    <!-- BANK -->
                    <div class="form-group row text-center">
