<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb>
            <x-slot name="breadcrumb">
                ...
                <p class="ml-1 text-sm font-medium hover:text-blue-800 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{__('app.EDITCLIENT')}}</p>
                </li>
            </x-slot>
        </x-breadcrumb>
    </x-slot>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        @foreach($client as $c)
        <form method="POST" action="{{route('Client.update',$c->uuid)}}" enctype="multipart/form-data">
            @csrf
            <!-- Item Code & Code Type -->
            ...
            <div class="mb-2">
              ...
              <input type="text" name="name" value="{{ $c->name }}" class="@error('name') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
              @error('name')
               <div>
                   <span class="font-medium text-red-600">{{$message}}</span>
               </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="email" value="{{ $c->email }}" class="@error('email') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('email')
                 <div>
                     <span class="font-medium text-red-600">{{$message}}</span>
                 </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="phone" value="{{ $c->mobile }}" class="@error('phone') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('phone')
                 <div>
                     <span class="font-medium text-red-600">{{$message}}</span>
                 </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="mb-2">
                    ...
                    <select name="gov" id="gov" class="@error('gov') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        <option selected value="{{$c->gov}}">{{$c->gov}}</option>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="mb-2">
                    ...
                    <select name="city" id="cities" class="@error('city') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        <option selected velue="{{$c->city}}">{{$c->city}}</option>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="building_number" value="{{ $c->building_number }}" class="@error('building_number') border border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
