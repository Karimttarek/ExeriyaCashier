...
use App\Exports\Reports\Finances\ExpenseExport;
...
{
    protected string $exportClass = ExpenseExport::class;
    protected string $printPreview = 'print.reps.general.expenses';

    private function Q(){
        return DB::table('receipt_details')->where('receipt_type',5)
