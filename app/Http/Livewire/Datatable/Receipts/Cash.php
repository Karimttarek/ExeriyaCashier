...
final class Cash extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    use Actions;
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('uuid')
            ->addColumn('no' , fn ($model) => '<a href="'.route('Cash.edit',$model->uuid).'">'. e($model->no) .'</a>' )
            ->addColumn('statement')
            ->addColumn('receipt_date', fn ($model) => '<a href="'.route('Cash.edit',$model->uuid).'">'. e( Carbon::parse($model->receipt_date)->format('Y/m/d-h:i')) .'</a>' )
            ->addColumn('receiver_name', fn ($model) => '<a href="'.route('Cash.edit',$model->uuid).'">'. e($model->receiver_name) .'</a>' )
            ->addColumn('statement')
            ->addColumn('receiver')
