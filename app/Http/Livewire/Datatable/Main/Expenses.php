...
final class Expenses extends PowerGridComponent
{
    ...
    */
    ...
    {
        return DB::table('expenses')->select('id','code','name','statement');
    }
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('code', fn ($model) => '<a href="'.route('Expenses.edit',$model->id).'">'. e($model->code) .'</a>' )
            ->addColumn('name', fn ($model) => '<a href="'.route('Expenses.edit',$model->id).'">'. e($model->name) .'</a>' )
            ->addColumn('statement');
    }
