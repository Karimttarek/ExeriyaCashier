...
final class Revenues extends PowerGridComponent
{
    ...
    */
    ...
    {
        return DB::table('revenues')->select('id','code','name','statement');
    }
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('code', fn ($model) => '<a href="'.route('Revenues.edit',$model->id).'">'. e($model->code) .'</a>' )
            ->addColumn('name', fn ($model) => '<a href="'.route('Revenues.edit',$model->id).'">'. e($model->name) .'</a>' )
            ->addColumn('statement');
    }
    ...
    */
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::make('Statement', 'statement')
                ->sortable()
                ->searchable()
                ->headerAttribute($text_dir)
                ->bodyAttribute('text-blue-500 hover:underline' ),
