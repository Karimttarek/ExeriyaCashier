    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('internal_id', fn ($model) => '<a href="'.route('Pur.edit',$model->uuid).'">'. e($model->internal_id) .'</a>' )
            ->addColumn('invoice_date', fn ($model) => '<a href="'.route('Pur.edit',$model->uuid).'">'. e( Carbon::parse($model->invoice_date)->format('Y/m/d-h:i')) .'</a>' )
            ->addColumn('issuer_name', fn ($model) => '<a href="'.route('Pur.edit',$model->uuid).'">'. e($model->issuer_name) .'</a>' )
