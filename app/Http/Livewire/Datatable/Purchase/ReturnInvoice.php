...
namespace App\Http\Livewire\Datatable\Purchase;
...
final class ReturnInvoice extends PowerGridComponent
{
    ...
    */
    ...
    public function datasource(): Builder
    {
        ...
        ->select('uuid','id','internal_id','invoice_date','issuer_name','total_tax','total_discount','total','items_count','status');
    }
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('internal_id', fn ($model) => '<a href="'.route('PurReturn.edit',$model->uuid).'">'. e($model->internal_id) .'</a>' )
            ->addColumn('invoice_date', fn ($model) => '<a href="'.route('PurReturn.edit',$model->uuid).'">'. e( Carbon::parse($model->invoice_date)->format('Y/m/d-h:i')) .'</a>' )
            ->addColumn('issuer_name', fn ($model) => '<a href="'.route('PurReturn.edit',$model->uuid).'">'. e($model->issuer_name) .'</a>' )
    ...
    */
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::make(__('app.SUPPLIER'), 'issuer_name')
                ->sortable()
                ->searchable()
                ->headerAttribute($text_dir)
                ->bodyAttribute('text-blue-500 hover:underline' ),
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::inputText('issuer_name')->operators(['contains']),
