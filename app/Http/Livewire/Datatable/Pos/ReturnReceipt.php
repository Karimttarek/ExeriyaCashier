...
final class ReturnReceipt extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    use Actions;
    ...
    */
    ...
    public function datasource()
    {
        ...
        ->orderBy('id' , 'desc')
        ->select('uuid','id','document_uuid','invoice_date','customer_name','total','items_count');
    }
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        ...
        ->addColumn('uuid')
        ->addColumn('document_uuid', fn ($model) => '<a href="'.route('POS.return.edit',$model->uuid).'">'. e($model->document_uuid) .'</a>' )
        ->addColumn('invoice_date', fn ($model) => '<a href="'.route('POS.return.edit',$model->uuid).'">'. e( Carbon::parse($model->invoice_date)->format('Y/m/d-h:i')) .'</a>' )
        ->addColumn('customer_name', fn ($model) => '<a href="'.route('POS.return.edit',$model->uuid).'">'. e($model->customer_name) .'</a>' )
