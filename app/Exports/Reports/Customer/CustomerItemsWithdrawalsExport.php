...
class CustomerItemsWithdrawalsExport extends DataTablesCollectionExport implements FromCollection , WithMapping ,WithHeadings  ,WithColumnWidths ,ShouldAutoSize,WithEvents ,WithColumnFormatting
{
    public function headings(): array
    {
        return [
            __('app.INVOICEDATE'), __('app.INVOICEID'), __('app.TAXREGORNID') ,__('app.CUSTOMER') ,__('app.ADDRESS'),__('app.ITEMCODE'),
            __('app.NAME')  ,__('app.QTY') ,__('app.UNITPRICE'),__('app.DISCOUNT'), __('app.NETPRICE'),
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Header Colors
                $event->sheet->getStyle('A1:R1')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => '95B3D7'],]);
                $event->sheet->getDelegate()->getRowDimension('1')->setRowHeight(20);
                $event->sheet->getDelegate()->getStyle('A1:R1')->getAlignment()->setVertical(Alignment::VERTICAL_CENTER);
                $event->sheet->getDelegate()->getStyle('A1:R1')->getAlignment()->setHorizontal(Alignment::VERTICAL_CENTER);
            },
        ];
    }
