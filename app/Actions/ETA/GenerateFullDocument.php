...
class GenerateFullDocument {
    ...
    public function GenerateDocument($uuid , $signature){
                ...
                'documents' =>
                    [
                        [
                            ...
                            "dateTimeIssued"=> date('Y-m-d\TH:i:s\Z' , strtotime(date('Y-m-d' , strtotime($head->invoice_date)). date('H:i:s' , strtotime(now())))),
//                            "dateTimeIssued"=> date("Y-m-d\Th:i:s\Z", strtotime($head->invoice_date)),
